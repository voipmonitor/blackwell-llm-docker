...
verify_lock vllm \
  ...
  649e4ce042c8380bd56b02578fb3bdd7e7840fef \
...
grep -Fxq 'vllm_tree=649e4ce042c8380bd56b02578fb3bdd7e7840fef' \
  <<<"${output}"
...
grep -Fxq 'lmcache_tree=86ee2a3bb5675cd3a25b09ad3e2f20dad4720f58' \
  <<<"${output}"
grep -Fq 'jovian-judgement-vllm649e4ce-b12xe58515a-fi803c466-cu133-torch213-20260906-r8' \
  <<<"${output}"
